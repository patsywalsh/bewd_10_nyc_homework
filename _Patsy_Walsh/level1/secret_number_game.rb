...
class SecretNumberGame
  ...
  def greet(player_name)
    puts "Hello #{player_name}! Welcome to the Secret Number Game. You have 5 chances to guess the secret number, it is between 1 and 15." #Create a string to use as your greeting. It should include the player_name and the rules, with the number of guesses the player gets.
  end
